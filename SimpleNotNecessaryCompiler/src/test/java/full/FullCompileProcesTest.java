...
public class FullCompileProcesTest {
	...
	public void simpleTwoStringTest() throws Exception {
		testExecute("   print   (   1   +   1    - 2    )    ;     " + System.lineSeparator() + "print(2);" + "", "0" + System.lineSeparator() + "2");
	}
	...
	public void simpleVariableTest() throws Exception {
		testExecute("x = 5 + 2; " + System.lineSeparator() + "y = x - 1;" + System.lineSeparator() + "print(x + y);" + "", "13");
	}
	...
	public void simpleIfTest() throws Exception {
		testExecute("x=-1; y=5; if(x<y)" + System.lineSeparator() + "{print(x);} else {print(y);}" + "", "-1");
	}
	...
	public void simpleWhileTest() throws Exception {
		testExecute("x=0; y=0; z=0; q=-1; while(x<5) {while(y<5){y=y+1;z=z+1;}x=x+1;y=0;} print(z);" + "", "25");
	}
	...
	public void equalsTest() throws Exception {
		testExecute("x=-1; y=5; if(x==y)" + System.lineSeparator() + "{print(x);} else {print(y);}" + "", "5");
	}
