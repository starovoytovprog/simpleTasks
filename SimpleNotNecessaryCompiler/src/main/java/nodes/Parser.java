...
public class Parser {
	...
	private Node rollUpExpression(Node expressionNode) {
		return rollUpEqualsExpression(rollUpLessThanExpression(rollUpMoreThanExpression(rollUpSumExpression(rollUpMinusExpression(expressionNode))))).getDependentNode(0);
	}
